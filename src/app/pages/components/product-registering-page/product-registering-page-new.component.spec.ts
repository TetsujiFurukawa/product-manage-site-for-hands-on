...
describe('ProductRegisteringPageComponent', () => {
  ...
  describe('#clickProductImageButton', () => {
    ...
    it('should load image', () => {
      ...
      const content = expectedResponse.productImage;
      const data = new Blob([content]);
      const arrayOfBlob = new Array<Blob>();
      arrayOfBlob.push(data);
  ...
  describe('#clickClearButton', () => {
    it('should clear', () => {
      component.productImage.setValue(expectedResponse.productImage);
  ...
  describe('#clickSaveButton', () => {
    ...
    it('should create data', async () => {
      matDialogSpy.open.and.returnValue({ afterClosed: () => of(true) });
      productServiceSpy.createProduct.and.returnValue(of(expectedResponse));
      component.clickSaveButton();
      expect(productServiceSpy.createProduct.calls.count()).toEqual(1);
  ...
  describe('DOM input/output test', () => {
    it('Should Enter input and create product register request', () => {
      ...
      HtmlElementUtility.setValueToHTMLInputElement<typeof component>(
        fixture,
        '#product-unit-price',
        expectedResponse.productUnitPrice.toString()
      );
      // Clicks checkbox's label
      HtmlElementUtility.clickHtmlElement<typeof component>(fixture, '#end-of-sale label');
      component.receivedEventFromChild(expectedResponse.endOfSaleDate.toString());
      fixture.detectChanges();
    ...
    it('Should Enter product code and get product stock data then display screen', () => {
      // tslint:disable-next-line: no-string-literal
      component['extractGetProductResponse'](expectedResponse);
      fixture.detectChanges();
