...
const VALUE_NOT_PRODUCT_IMAGE = 'data:image/jpeg;base64,/9j/4QAYRXh';
...
describe('ProductRegisteringPageComponent', () => {
  ...
  describe('#clickProductImageButton', () => {
    it('should return When there is no file', () => {
      spyOn(component.fileReader, 'readAsDataURL').and.callThrough();
      component.clickProductImageButton(Array());
      expect(component.fileReader.readAsDataURL).toHaveBeenCalledTimes(0);
    });
    it('should return when not images', () => {
      // Setups non image file.
      const arrayOfBlob = new Array<Blob>();
      arrayOfBlob.push(new Blob([VALUE_NOT_PRODUCT_IMAGE]));
    ...
    it('should load image', () => {
      // Setups image file.
      const arrayOfBlob = new Array<Blob>();
      arrayOfBlob.push(new Blob([VALUE_PRODUCT_IMAGE]));
      const imageFile = new File(arrayOfBlob, 'test01.img', { type: 'application/image' });
      spyOn(component.fileReader, 'readAsDataURL').and.callThrough();
      component.clickProductImageButton(Array(imageFile));
      expect(component.fileReader.readAsDataURL).toHaveBeenCalledWith(imageFile);
    });
  });

  describe('#clickClearButton', () => {
    it('should clear', () => {
      component.productImage.setValue(VALUE_PRODUCT_IMAGE);
  ...
  describe('#clickSaveButton', () => {
    it('should create data but response is null', async () => {
  ...
  describe('DOM placeholder', () => {
    it('title', () => {
      const htmlInputElement: HTMLInputElement = fixture.debugElement.query(By.css(IDS.TITLE)).nativeElement;
    ...
    it('product genre', () => {
      const hTMLLabelElement: HTMLLabelElement = fixture.debugElement.query(By.css(IDS.PRODUCT_GENRE_LABEL))
        .nativeElement;
    ...
    it('product unit price', () => {
      const htmlInputElement: HTMLInputElement = fixture.debugElement.query(By.css(IDS.PRODUCT_UNIT_PRICE))
        .nativeElement;
      expect(htmlInputElement.dataset.placeholder).toContain('単価');
    });
    it('product end of sale', () => {
      const htmlInputElement: HTMLInputElement = fixture.debugElement.query(By.css(IDS.END_OF_SALE)).nativeElement;
    ...
    it('product end of sale date', () => {
      ...
      fixture.whenStable().then(() => {
        const htmlInputElement: HTMLInputElement = fixture.debugElement.query(By.css(IDS.END_OF_SALE_DATE))
          .nativeElement;
  ...
  describe('DOM input validation test', () => {
    ...
    it('should enter the correct value both the end Of sale and end Of sale date', async () => {
      HtmlElementUtility.setValueToHTMLInputElement<typeof component>(
        fixture,
        IDS.PRODUCT_CODE,
        VALUE_PRODUCT_CODE_LOWER
  ...
  describe('DOM input/output test', () => {
    ...
    it('Should Enter product code and get product stock data then display screen', () => {
      ...
      fixture.whenStable().then(() => {
        ...
        //
        expect(fixture.debugElement.query(By.css(IDS.END_OF_SALE_INPUT)).nativeElement.checked).toBeTruthy();
...
function createExpectedProductDto() {
  const expectedProductDto: ProductDto = {
    ...
    productImage: VALUE_PRODUCT_IMAGE,
